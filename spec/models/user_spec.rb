...
describe User do
  ...
  it "should reject invalid email addresses" do
    addresses = %w[user@foo,com THE_USER_AT.org first.last@foo.]
    addresses.each do |addy|
  ...
  it "should reject duplictae email addresses" do
    User.create!(@attr)
  ...
  describe "password validations" do
    ...
    it "should match the password" do
      User.new(@attr.merge(:password_confirmation => "gfedcba")).should_not be_valid
    end
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should respond to authenticate(string)" do
